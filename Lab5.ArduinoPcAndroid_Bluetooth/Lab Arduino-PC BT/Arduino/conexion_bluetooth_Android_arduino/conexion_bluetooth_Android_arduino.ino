...
void sendAndroidValues(){
  Serial2.print( char(random(34,120)) );
  Serial.print( char(random(0,255)) );
  delay(1000);        //agregamos este delay para eliminar tramisiones faltantes
}
